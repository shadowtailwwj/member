...
$listid = $_GET['id'];
$pid=2001001;
$skeys = 'ID,No,Title,Domain,Counts,State,STime,ETime,CRM_ID';
...
if($sub=="action"){
    $pid1=2001003;
    $send = '{"title":"'.$title.'","domain":"'.$domain.'"}';
        ...
        <div class="editwa">
          ...
          <div class="xiutnr">
            <ul class="editul">
              ...
              <li>
                  <div class="editzuo">站点域名： </div>
                  <div class="edityou"><input type="text" class="editipt" value="<?php echo $info['RETURN']['MESSAGE'][0]['domain'] ?>" name="domain" /></div>
              </li>
              <li>
...
<script>
    $(".tijoaobtn").click(function(){
        ...
        var url = "site_edit.php";
        var data = {domain:domain,title:title,sub:sub,listid:listid};
        $.post(url,data,function(data){
            if(data==1){
                self.location='site_edit.php';
            }else{
                alert("修改错误");
            }
        })
