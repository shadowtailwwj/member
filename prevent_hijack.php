                ...
                <div class="ddtaner">
                    <table class="ddastbls">
                        ...
                        <tr>
                            ...
                            <?php if($val['monitor']==1){?>
                                <td><a href="abnormal.php?id=<?php echo $val['id'] ?>" class="xufei1" >异常记录</a></td>
                            <?php }elseif($val['monitor']==2){ ?>
                                <td>未开启监控</td>
                            <?php } ?>
                            <?php if($val['state']==1){?>
                                <td><a href="#" class="xufei1" >启用</a></td>
                            <?php }elseif($val['state']==2){ ?>
                                <td><a href="#" class="xufei1" >未启用</a></td>
                            <?php } ?>
                            <td><a href="#" class="xufei1" >手机</a> | <a href="#" class="xufei1">邮箱</a></td>
                            <td><a href="prevent_hijack_edit.php?id=<?php echo $val['id'] ?>" class="xufei1" >修改</a> | <a href="#" class="xufei1">删除</a></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td><input type="checkbox" value="" /></td>
