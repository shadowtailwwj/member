...
if($sub=="action"){
    $pid1=2001009;
    $send = '{"title":"'.$title.'","ldomain":"'.$ldomain.'"}';
        ...
        <div class="editwa">
          ...
          <div class="xiutnr">
            <ul class="editul">
              ...
              <li>
                  <div class="editzuo">长域名： </div>
                  <div class="edityou"><input type="text" class="editipt" value="<?php echo $info['RETURN']['MESSAGE'][0]['ldomain'] ?>" name="ldomain" /></div>
              </li>
              <li>
...
<script>
    $(".tijoaobtn").click(function(){
        ...
        var url = "short_domainname_edit.php";
        var data = {ldomain:ldomain,title:title,sub:sub,listid:listid};
        $.post(url,data,function(data){
            if(data==1){
                self.location='short_domainname_edit.php';
            }else{
                alert("修改错误");
            }
        })
