...
$ID = $_SESSION["uid"];
$where = '=|CRM_ID|'.$ID.'|';
$skeys = 'ID,No,Title,Domain,Counts,V_State_Title,STime,ETime,CRM_ID';
                ...
                <div class="ddtaner">
                    <table class="ddastbls">
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td><a href="site_edit.php?id=<?php echo $val['id'] ?>" class="xufei1" >修改</a> | <a href="#" class="xufei1">删除</a></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td><input type="checkbox" value="" /></td>
